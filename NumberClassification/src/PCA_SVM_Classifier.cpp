...
int PCA_SVM_Classifier::getClassificationIdx(const string& filepath) {
...
void PCA_SVM_Classifier::PCA_set_push_back(Mat& PCA_set, const Mat& img) {
	Mat PCA_set_row;
...
void PCA_SVM_Classifier::PCA_set_add(Mat& PCA_set, vector<int>& trainingBubbleValues, const string& filename, bool flipExamples) {
...
bool PCA_SVM_Classifier::train_classifier(const vector<string>& examplePaths, Size myExampleSize, int eigenvalues, bool flipExamples) {
...
inline double PCA_SVM_Classifier::rate_item(const Mat& det_img_gray, const Point& item_location) const {
...
Point PCA_SVM_Classifier::align_item(const Mat& det_img_gray, const Point& seed_location, double alignment_radius) const {
	int iterations = 10;
	#define CHECKED 123
...
string PCA_SVM_Classifier::classify_item(const Mat& det_img_gray, const Point& item_location) const {
...
void PCA_SVM_Classifier::save(const string& outputPath) const throw(cv::Exception){
...
void PCA_SVM_Classifier::load(const string& inputPath) throw(cv::Exception){
