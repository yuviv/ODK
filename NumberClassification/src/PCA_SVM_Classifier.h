...
/*
 * PCA_SVM_Classifier.h
 *
 * This class does classification on what digit an image corresponds to.
 *
 *  Created on: Apr 19, 2014
 *      Author: Vivian
 */
class PCA_SVM_Classifier
{
	private:
	...
	public:
		...
		PCA_SVM_Classifier(): statClassifier(new CvSVM){}
